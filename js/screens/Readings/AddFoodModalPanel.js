    ...
    render() {
        ...
        return (
            <View style={{flex: 9}}>
                ...
                <ModalDateInputRow inputDate={this.props.inputDate} handleDateChange={this.props.handleDateChange} fontSize={labelSize}/>
                <ModalValueInputRow inputLabel='Calories' inputValue={this.props.inputCalories} onChangeText={this.props.onChangeCalories} fontSize={labelSize}/>
                ...
                <ModalValueInputRow inputLabel='Carbohydrates' inputValue={this.props.inputCarbohydrates} onChangeText={this.props.onChangeCarbohydrates} fontSize={labelSize}/>
